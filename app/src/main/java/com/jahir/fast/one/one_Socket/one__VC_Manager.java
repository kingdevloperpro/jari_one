...
public class one__VC_Manager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.two__vc_manager);
...
//        modelPrefrences = new ModelPrefrences(this);
            ...
            public void run() {
                ...
                if (Comman.mainResModel != null && Comman.mainResModel.getData().getExtraFields().getVideo_call().equalsIgnoreCase("on")) {
                    ...
                    button.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (StartButtonActivity.isNetworkConnected(getApplicationContext()))
                                startActivity(new Intent(one__VC_Manager.this, one__VC_Manager.class));
                            finish();
                        }
                    });
                }
    ...
    private void Show_Dialog() {
        try {
            AlertDialog.Builder builder = new AlertDialog.Builder(one__VC_Manager.this);
            final View view = getLayoutInflater().inflate(R.layout.two__dlg_sex, null);
            ...
            txt_con.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(one__VC_Manager.this, one__LiveCall.class));
                    finish();
                }
            });
            dialog.show();
