package com.jahir.fast.one.one_Socket;
...
public class one__LiveCall extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.two__vc_live);
        ...
        actionBlock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(one__LiveCall.this);
                final View view = getLayoutInflater().inflate(R.layout.two__dlg_block, null);
                ...
                yes.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(one__LiveCall.this, "User blocked successful!", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                        onBackPressed();
                    }
                });
        ...
        actionDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final View view = getLayoutInflater().inflate(R.layout.two__dlg_report, null);
                builder.setView(view);
                AlertDialog dialog = builder.create();
                dialog.setCancelable(true);
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        ...
        iv_swich_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(one__LiveCall.this, "Please don't click many times!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void actionReport(Dialog dialog) {
        Toast.makeText(one__LiveCall.this, "Report submitted.", Toast.LENGTH_SHORT).show();
        dialog.dismiss();
        onBackPressed();
    }
